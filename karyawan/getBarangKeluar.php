...
$i = 1;
$barangMasuk = mysqli_query($koneksi, " SELECT barang.`id_barang`, barang.`nama_barang`, history_barang.`jenis_transaksi`,
history_barang.`tanggal_transaksi`, history_barang.`jumlah`
FROM history_barang JOIN barang ON history_barang.`id_history` = barang.`id_barang` 
